...
This is a demo app to show the Rails version 8.1 feature to configure and run the CI workflow locally. There is an option to use the GitHub CLI tool [`gh-signoff`](https://github.com/basecamp/gh-signoff) for setting the PR status based on the result of running all the CI steps.
